...
A patch version is a focused repair cycle. It gets its own concept doc seeded from the parent minor version's concept, plus its own tasklist and stage progression.
...
└── docs/
    ...
    │   └── v1.1.1/
    │       ├── CCC_concept.md      ← seeded from v1.1 concept
